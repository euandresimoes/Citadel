...
describe("network providers", () => {
  ...
  it("parses a Citadela mDNS service advertisement", () => {
    expect(parseLanMdnsRecords([
      { name: "_citadela._tcp.local", type: "PTR", data: "Citadela Hub._citadela._tcp.local" },
      { name: "Citadela Hub._citadela._tcp.local", type: "SRV", data: { target: "hub.local", port: 75523 } },
