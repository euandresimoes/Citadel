...
interface DeviceRow { device_id: string; algorithm: "ed25519"; public_key: string; fingerprint: string; network_mode: NetworkMode; connection_id: string | null; status: DeviceStatus; connected_at: Date | null; last_seen_at: Date; system_info: SystemInfo | null; metrics: SystemMetrics | null; }
